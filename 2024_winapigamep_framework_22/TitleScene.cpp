...
{
	{
		...
		ImageUI* ui = new ImageUI({ 100,500 }, { 150, 850 }, WINDOW_TYPE::COPY, sprite);
	...
	}
	{
		...
		ImageUI* ui = new ImageUI({ 270,550 }, { 200, 850 }, WINDOW_TYPE::COPY, sprite);
		addObject(ui, LAYER::UI);
		ui->openTween(1.2f);
	...
	}
	{
		...
		ImageUI* ui = new ImageUI({ 450,450 }, { 220, 800 }, WINDOW_TYPE::COPY, sprite);
		addObject(ui, LAYER::UI);
		ui->openTween(1.4f);
	...
	}
	{
		...
		ImageUI* ui = new ImageUI({ 600,500 }, { 100, 600 }, WINDOW_TYPE::COPY, sprite);
		addObject(ui, LAYER::UI);
		ui->openTween(1.6f);
